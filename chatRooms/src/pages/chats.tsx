...
if(!user) return <h1>loading...</h1>
  ...
  return (
    <div className=' h-screen overflow-hidden'>
        <Nav />
        {
          showChat ? (<div className=" relative">
            <div className='flex items-center p-2 shadow-xl font-black fixed w-full z-10 bg-gray-300 '>
              <button onClick={()=>setShowChat(false)} className='bg-gray-100 py-1 px-2 rounded-lg flex flex-col items-center justify-center mr-2 text-xs'>back</button>
              <h1 className='border-l-2 px-2 border-gray-400'>{caption[0]?.author}</h1>
            </div>
          <div className=" ">
          <ScrollToBottom className='w-full h-[77vh] pt-10'>
                ...
                return (
                  ...
                  >
                    <div >
                      ...
                      <div className={`text-xs flex flex-col p-2 ${user.displayName === messageContent.author ? " items-end":"items-start"}`}>
          ...
          <div className="border-t-2 border-gray-400 px-4 pt-4 pb-4 mb-2 sm:mb-0 flex items-center justify-around">
            <input
        ...
        </div>) : (<div className='w-full h-[70%] flex flex-col items-center justify-center'>
        ...
        <div className="mt-8">
          ...
          />
          <button className='bg-blue-300 hover:bg-gray-100 hover:text-blue-300 p-2 mt-2 rounded-lg text-xs ' onClick={joinRoom}>Join Room</button>
        </div>
        </div>
        </div>
       )
